    ...
    Tree.prototype = {
        ...
        setConnectionToParent: function( treeNode, hidePoint ) {
            ...
            if ( this.connectionStore[treeNode.id] ) {
                ...
                connLine.attr('arrow-start', 'classic-wide-long');
                connLine.attr('stroke-width', (300/treeNode.Y));
        ...
        addConnectionToNode: function( treeNode, hidePoint, targetNode, color) {
            var stacked = treeNode.stackParentId,
                connLine,
                parent = ( targetNode ),
                ...
                pathString = hidePoint?
                    this.getPointPathString(hidePoint):
                    this.getPathString(parent, treeNode, stacked, 25);
         ...
         * @returns {string}
         */
        getPathString: function( from_node, to_node, stacked, other ) {
